...
**Solana Raydium Sniper Bot** that listens to new Raydium SOL pools and buys tokens for a fixed amount in SOL.
...
13. `MIN_POOL_SIZE` (script will buy only if sol amount in liquid pool is greater than this, normally is 50 or above)
